...
function CreateProductForm({ onCancel }: { onCancel: () => void }) {
  ...
  // No success toast: creation redirects to the new product, and arriving
  ...
  return (
    <form action={formAction}>
      <DialogHeader>
        ...
        <DialogDescription>
          Keyren assigns a permanent product ID. Renaming the product later never changes
          it.
        </DialogDescription>
      </DialogHeader>
...
export function CreateProductDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <CreateProductForm key={session} onCancel={() => setOpen(false)} />
      </DialogContent>
    </Dialog>
  );
}
