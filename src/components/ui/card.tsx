...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // rounded-lg (8px), not xl: a 12px corner on a data container is a
        // consumer-app radius applied to information density. The ring is the
        // alpha-composited border technique, retargeted at --border so it
        // survives on every surface rather than only on the card.
